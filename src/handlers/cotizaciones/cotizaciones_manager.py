...
def update_cotizacion_handler(event, context):
    try:
        ...
        for fld in (
            ...
            "nivel_tanque", "testigos_encendidos", "inventario",
            "proximo_cambio_aceite", "proximo_cambio_bujias",
            "proximo_cambio_aceite_fecha", "proximo_cambio_bujias_fecha",
            "mecanico_id", "mecanico_nombre",
            "aplica_costo_revision", "costo_revision", "fechaEstimadaEntrega",
        ):
            if fld in body:
...
def convertir_a_os_handler(event, context):
    ...
    try:
        ...
        os_doc = {
            ...
            "proximo_cambio_aceite_fecha": body.get("proximo_cambio_aceite_fecha") if body.get("proximo_cambio_aceite_fecha") is not None else cot.get("proximo_cambio_aceite_fecha"),
            "proximo_cambio_bujias_fecha": body.get("proximo_cambio_bujias_fecha") if body.get("proximo_cambio_bujias_fecha") is not None else cot.get("proximo_cambio_bujias_fecha"),
